...
const PendingRequests = () => {
    ...
    const donorColumns = [
		...
		},
        {
		    ...
		    cell: (row) => <div className='flex gap-1'>
                <button  onClick={()=> handleAcceptRequest(row)} className='p-2 my-2 font-semibold bg-green-500 shadow-sm shadow-black active:bg-green-700' type="button">
                    Accept
                </button>
                <button  onClick={()=> handleDeclineRequest(row)} className='p-2 my-2 font-semibold bg-red-500 shadow-sm shadow-black active:bg-red-700' type="button">
                    Decline
                </button>
            </div>,
            width: '170px',
    ...
    const ExpandedComponentSeeker = ({ data }) => <div className='flex items-start justify-start gap-4 p-3 overflow-auto bg-gray-200 h-fit'>
    ...
    const ExpandedComponentDonor = ({ data }) => <div className='flex items-start justify-start gap-4 p-3 overflow-auto bg-gray-200 h-fit'>
        <div className='w-32 h-32'>
            <img src={placeholder} alt="profile" width={"100%"} className="border-2 border-red-900 rounded-full shadow-md shadow-red-900"/>
        </div>
        <div className='flex flex-col items-start justify-center w-1/3 h-full gap-2 '>
